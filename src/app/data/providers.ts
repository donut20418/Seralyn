    ...
    accounts: [
      {
        ...
        status: "connected",
        models: [
          { id: "sonnet-5", label: "Sonnet 5", contextWindow: 200_000 },
          { id: "opus-5", label: "Opus 5", contextWindow: 200_000 },
          { id: "haiku-4-5", label: "Haiku 4.5", contextWindow: 200_000 },
        ],
      },
      {
        id: "claude-personal",
    ...
    accounts: [
      {
        ...
        status: "connected",
        models: [
          { id: "gpt-5.1-codex", label: "GPT-5.1-Codex", contextWindow: 272_000 },
          { id: "gpt-5.1-codex-mini", label: "GPT-5.1-Codex-mini", contextWindow: 272_000 },
        ],
      },
    ],
  },
    ...
    accounts: [
      {
        ...
        status: "connected",
        models: [
          { id: "gemini-3-pro", label: "Gemini 3 Pro", contextWindow: 1_000_000 },
