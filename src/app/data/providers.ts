    ...
    accounts: [
      {
        ...
        status: "connected",
        models: [
          { id: "sonnet", label: "Claude Sonnet (Latest)", contextWindow: 1_000_000 },
          { id: "opus", label: "Claude Opus (Latest)", contextWindow: 1_000_000 },
          { id: "haiku", label: "Claude Haiku (Latest)", contextWindow: 200_000 },
    ...
    accounts: [
      {
        ...
        models: [
          ...
          { id: "gpt-4.5", label: "GPT-4.5", contextWindow: 128_000 },
    ...
    accounts: [
      {
        ...
        models: [
          ...
          { id: "gemini-3.1-pro-preview", label: "Gemini 3.1 Pro Preview", contextWindow: 1_000_000 },
